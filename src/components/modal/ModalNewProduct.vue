      ...
      <div class="w-100 h-100 bg-white px-3 pt-4 pb-4">
        ...
        <div class="w-100 mt-2">
          ...
          <div class="w-100 modalAddProduct">
            ...
            <input type="text" id="ctegory_name" class="inputAddProduct" :value="getCategoryName">
            <form class="w-100" method="post" @submit.prevent="createProduct">
              <input type="text" class="inputAddProduct" placeholder="введите наименование продукта"
                    v-model="product">
