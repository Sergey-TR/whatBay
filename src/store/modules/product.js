...
export default {
    actions: {
        async getOrderProducts({dispatch, commit}, {order_id, shop_name, user_id, day}) {
            API.get(baseURL + 'orders' + '?order_id=' + order_id + '&shop=' + shop_name
        ...
        async createNewOrdersProduct({dispatch, commit},
               {product_name, category_id, category_name, shop_name, shop_id, day, order_id, is_success, user_id, list_id}) {
        ...
        async createNewProduct({dispatch, commit},
                                     {product_name, category_id, user_id}) {
        ...
        async getProductFromUserId({dispatch, commit}, {id}) {
